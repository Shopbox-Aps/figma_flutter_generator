class FigmaConstants {
  ...
  static const String mappedCollectionNotFoundError =
      'Mapped collection not found';
  static const String fetchVariablesError =
      'Failed to fetch variables from Figma';
